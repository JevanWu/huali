...
class CreateProvCityArea < ActiveRecord::Migration
  ...
  provinces.each do |province|
    id, post_code, name = province
    Province.create!(post_code: post_code, name: name)
  end

  # cities = [ [`id`, `post_code`, `name`, `parent_post_code`], ... ]
  cities.each do |city|
    id, post_code, name, parent_post_code = city
    City.create!(post_code: post_code, name: name, parent_post_code: parent_post_code)
  end

  # area = [ [`id`, `post_code`, `name`, `parent_post_code`], ... ]
  areas.each do |area|
    id, post_code, name, parent_post_code = area
    Area.create!(post_code: post_code, name: name, parent_post_code: parent_post_code)
  end
end
