$ljz_region = BorderPatrol.parse_kml(File.read(File.expand_path('../../ljz.kml', __FILE__)))
...
$inner_ring = BorderPatrol.parse_kml(File.read(File.expand_path('../../huangpu2.kml', __FILE__)))
