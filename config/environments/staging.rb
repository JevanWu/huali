Huali::Application.configure do
  ...
  config.assets.precompile += %w( mobile.css ie6.css ie7.css jquery.ui.datepicker.css home.js collections.js products.js pages.js ga.js html5shiv.js datepicker-settings.js)
