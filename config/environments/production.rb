Huali::Application.configure do
  ...
  config.assets.precompile += %w( oauth.js segmentio.js admin_order_print.css admin_order_print.js bootstrap-slider.js bootstrap-slider.css prov_city_area_update.js json3.js active_admin/sortable.js active_admin/sortable.css invitation.css )
