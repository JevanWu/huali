Huali::Application.configure do
  ...
  config.assets.precompile += %w( application-mobile.js admin_shipment_print.css email.css mobile.css pc.css ie7.css active_admin_print.css jquery.ui.datepicker.css home.js collections.js products.js pages.js ga.js html5shiv.js datepicker-settings.js jquery.imagesloaded.js weibo-stories.js)
