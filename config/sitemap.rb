...
SitemapGenerator::Sitemap.create do
  ...
  promotion_collections = %w(givenchy davidoff chloe sally-hansen marc-jacobs swarovski-elements ermenegildo-zegna helena-rubinstein).map { |slug| Collection.friendly.find(slug) }
