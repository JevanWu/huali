...
SitemapGenerator::Sitemap.create do
  ...
  promotion_collections = %w(haagen-dazs philips acqua-di-parma givenchy davidoff chloe sally-hansen marc-jacobs swarovski-elements ermenegildo-zegna helena-rubinstein coach eco-more candenzza Baccarat).map { |slug| Collection.friendly.find(slug) }
