...
module Huali
  class Application < Rails::Application
    ...
    config.autoload_paths += %W(#{config.root}/models/validators #{config.root}/lib #{config.root}/app/workers #{config.root}/app/values #{config.root}/app/services)
