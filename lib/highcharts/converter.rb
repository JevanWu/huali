...
module Highcharts
  class Converter
    ...
    def self.run(chart_options)
      ...
      image_filename = "#{SecureRandom.hex(32)}.png"
      ...
      begin
        ...
        system "#{phantomjs_path} #{File.expand_path('../highcharts-convert.js', __FILE__)} -infile #{chart_options_file.path} -outfile #{outfile_path} -type png -constr Chart -width 1440"
      ensure
