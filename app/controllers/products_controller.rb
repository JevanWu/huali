...
class ProductsController < ApplicationController
  ...
  def index
    ...
    @products = @products.uniq.page(params[:page]).per(is_mobile_request? ? 8 : 9).order_by_priority
  ...
  def greeting_card
    ...
    if @greeting_card.save and Notify.delay.product_greeting_card_email(@greeting_card.id)
  ...
  def reply_greeting_card
    ...
    if @reply_greeting_card.save and Notify.delay.product_reply_greeting_card_email(@reply_greeting_card.id)
  ...
  private
    ...
    def greeting_card_params
      params.require(:greeting_card).permit(:sender_email, :recipient_email, :sentiments, :user_id, :product_id, :uuid, :sender_nickname, :recipient_nickname)
    end
